(function () {
    let paraContents = {
        ...
        experience: {
            ...
            在累積設計經驗的途中，我也接觸了各種行業，從美妝保養、冷凍食品、工商顧問、電器電子、印刷業到客製禮品業等等，我都有與這些行業裡的人一起共事過，或是在公司裡待過，多虧這些經歷，我接觸了很多不同風格的設計，也能夠隨著各行業的不同和公司的需求，來因應設計上的變化，除此之外，我在職場中也參與過各種不同的工作流程，這也讓我在處理各種工作事務上的方式比其他人更加靈活多樣，藉此來達到更好的工作效率，我想這些事情，是待在正規設計公司裡都無法體會到的吧。`,
    ...
    function optionTitleClickEvent() {
        ...
        setTimeout(function () {
            ...
            aboutMeSection.removeEventListener('mousemove', imgParallax)
        }, 200)
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                imgsBox.classList.remove('show')
                setRandomNumForIMGs()
                aboutMeSection.addEventListener('mousemove', imgParallax)
            }, 2000)
    ...
    // img Parallax Effect
    let aboutMeSection = document.querySelector('#about_me')

    function getRandom() {
        let PNnumToggle = [0, 1, -1]
