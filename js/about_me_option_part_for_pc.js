...
let paraContents = {
    ...
    experience: {
        ...
        在累積設計經驗的途中，我也接觸了各種行業，從美妝保養、冷凍食品、工商顧問、電器電子、印刷業到客製禮品業等等，我都在這些行業裡待過，多虧這些經歷，我接觸了很多不同風格的設計，也能夠隨著各行業的不同和公司的需求，來因應設計上的變化，除此之外，我在職場中也參與過各種不同的工作流程，這也讓我在處理各種工作事務上比其他人更加靈活多樣，藉此達到更好的工作效率，我想這些事情如果是進入正規設計公司都無法體會到的吧。`,
    ...
    about_now: {
        para: `現在的我任職於一間電商公司設計部的主管，雖然目前待在主管之位，但我還是依然致力於學習跟設計領域相關的知識與技術，當然學習的內容是自己感興趣的事物，雖然曾被一位在職場上遇到的設計前輩說過：『在名為設計這條既寬闊且看不到盡頭的路上，必須與時俱進』，雖然我覺得她說得沒錯，我也認同，但我也不是那種會去拼命學習連自己都起不了興趣事物的人，畢竟學習還是得伴隨著興致，才會有樂趣嘛~死命去學沒興趣的事物，說實話那是種痛苦，所以今天的我也是運用著工作以外的所有時間，學習著自己感興趣的事物。<br><br>
        目前還有3D建模渲染、美術設計、網頁後端技術...等等如此多感興趣的事物等著我去學習探討，期待將來的某天能夠學會興趣清單上的所有項目，除了讓自己的實力更上一層樓之外，結合當前所有習得的技術所創作出來的作品更讓我期待。`,
